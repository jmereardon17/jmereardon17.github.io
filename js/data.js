...
const about = `
  ...
  <p>Although this happened, occasionally something kept pulling me back to it and I would code webpages again. In 2018 I found <a class="link" href="https://teamtreehouse.com" target="_blank">Treehouse</a> where I began learning through their courses on web development. I picked up the Front End Web Development techdegree program in 2019, which I went on to complete in 2020. During my time in working through the curriculum, I was offered the role of Student Developer Moderator which is a program offered by Treehouse to students who they find to be engaging, valuable, standing out as exceptionally helpful and informative to others. Through this role, I was able to gain some exclusive invaluable experience throughout the techdegree program as I was responsible for helping student developers with their projects and offering feedback on their code.</p>
